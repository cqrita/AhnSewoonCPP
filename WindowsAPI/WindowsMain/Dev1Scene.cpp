...
void Dev1Scene::Init()
{
	...
	SetPlayerResource();
	Texture* texture=GET_SINGLE(ResourceManager)->LoadTexture("T_background", "image/background.bmp", RGB(255, 0, 255));
	...
	{
		_player = new Player();
		_player->SetPlayerInfo(Rect::MakeCenterRect(80, 80, 200, 200));
		{
